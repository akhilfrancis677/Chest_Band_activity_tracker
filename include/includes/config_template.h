...
#define CFG_PROXI_FAST_CONN_ADV_INTERVAL_MIN    (0x80)  /**< 80ms */
#define CFG_PROXI_FAST_CONN_ADV_INTERVAL_MAX    (0xA0)  /**< 100ms */
#define CFG_PROXI_LP_CONN_ADV_INTERVAL_MIN      (0x640) /**< 1s */
#define CFG_PROXI_LP_CONN_ADV_INTERVAL_MAX      (0xFA0) /**< 2.5s */
...
#define CFG_PROXI_IO_CAPABILITY                  CFG_IO_CAPABILITY_DISPLAY_ONLY

/**< MITM modes  */
#define CFG_MITM_PROTECTION_NOT_REQUIRED      (0x00)
#define CFG_MITM_PROTECTION_REQUIRED          (0x01)

#define CFG_PROXI_MITM_PROTECTION                CFG_MITM_PROTECTION_REQUIRED
 ...
 * 0: packet is sent at max tPROXIoughput
 ...
 */
/**< 20ms */
#define TIMERSERVER_OFF_MODE_TPROXIESHOLD            (20000/CFG_TS_TICK_VAL)
 ...
 * Only one the the tPROXIee configuration shall be enabled
 *
...
#define BLE_CFG_PROXIS_NUMBER_OF_CUSTOM_CHAR    0 /**< Number of characteristic added by the user */
#define BLE_CFG_PROXIS_BODY_SENSOR_LOCATION_CHAR           1 /**< BODY SENSOR LOCATION CHARACTERISTIC */
#define BLE_CFG_PROXIS_ENERGY_EXPENDED_INFO_FLAG           1 /**< ENERGY EXTENDED INFO FLAG */
#define BLE_CFG_PROXIS_ENERGY_RR_INTERVAL_FLAG             9 /**< Max number of RR interval values - Shall not be greater than 9 */
 ...
 * This parameter defines the number of asyncPROXIonous events that can be stored in the HCI layer before
 * being reported to the application. When a command is sent to the BlueNRG coprocessor, the HCI layer
 * is waiting for the event with the Num_HCI_Command_Packets set to 1. The receive queue shall be large
 * enough to store all asyncPROXIonous events received in between.
 * When CFG_TLBLE_MOST_EVENT_PAYLOAD_SIZE is set to 27, this allow to store tPROXIee 255 bytes long asyncPROXIonous events
 * between the HCI command and its event.
 * This parameter depends on the value given to CFG_TLBLE_MOST_EVENT_PAYLOAD_SIZE. When the queue size is to small,
 * the system may hang if the queue is full with asyncPROXIonous events and the HCI layer is still waiting
